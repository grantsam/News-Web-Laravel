...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.news-card, .news-image, .side-bar-news, .popular-news, .popular-item-sidebar, .side-bar-item, .news-image-sidebar,.news-card-more,.colomn-more').forEach((item, index) => {
        setTimeout(() => {
